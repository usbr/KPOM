...
#KROM Outputs
Model_Sim = read.xlsx(paste(Sys.getenv("KLAMATH_OPS"),"/Testing/KROM Outputs.xlsx", sep = ""), 
                  sheet=3, colNames=TRUE, cols=2:10, na.strings = "NaN")
Model_Dem = read.xlsx(paste(Sys.getenv("KLAMATH_OPS"),"/Testing/KROM Outputs.xlsx", sep = ""), 
                  sheet=1, colNames=TRUE, cols=2:9, na.strings = "NaN")
Model_Hyd = read.xlsx(paste(Sys.getenv("KLAMATH_OPS"),"/Testing/KROM Outputs.xlsx", sep = ""), 
                  sheet=2, colNames=TRUE, cols=2:6, na.strings = "NaN")

#PA Calculator Outputs
PA_Sim = read.xlsx(paste(Sys.getenv("KLAMATH_OPS"),"/Testing/PA_Calc_Outputs.xlsx",
                                sep = ""), sheet=1, colNames=TRUE, cols=2:10)
PA_Dem = read.xlsx(paste(Sys.getenv("KLAMATH_OPS"),"/Testing/PA_Calc_Outputs.xlsx",
                                sep = ""), sheet=2, colNames=TRUE, cols=2:9)
PA_Hyd = read.xlsx(paste(Sys.getenv("KLAMATH_OPS"),"/Testing/PA_Calc_Outputs.xlsx",
                                sep = ""), sheet=3, colNames=TRUE, cols=2:6)
```

#Create Variables for Data Processing and Visualization 
```{r echo = FALSE, warning = FALSE, message = FALSE}
#List general characteristics of the data
NumData = length(Model_Sim[,1])-1
Dates = seq(as.Date("2019-10-1"), as.Date("2021-02-27"), by="days")
StartDate = as.Date("2020-07-22")
