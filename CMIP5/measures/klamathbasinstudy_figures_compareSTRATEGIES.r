...
temp<-select(measures_eco,measure,scenario,period,climset,strategy,value,value_hist)
...
measures_eco2030$strategy <- factor(measures_eco2030$strategy,levels = c("Baseline", "Reduce ET 30%", "Reduce ET 50%", "Add 30KAF"))
ggplot(measures_eco2030, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_eco2030,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_eco2030$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-90, 20) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
...
ggplot(measures_eco2030b, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_eco2030b,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_eco2030b$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-90, 20) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_eco_LKNWR_STRATEGIES_2030.png", width=6, height=1.5, dpi=300)
...
ggplot(measures_eco2070b, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_eco2070b,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_eco2070b$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-90, 20) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_eco_LKNWR_STRATEGIES_2070.png", width=6, height=1.5, dpi=300)
...
ggplot(measures_flood2030b, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_flood2030b,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_flood2030b$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-30, 10) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_flood_UKLrel_STRATEGIES_2030.png", width=6, height=1.5, dpi=300)
...
ggplot(measures_flood2070b, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_flood2070b,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_flood2070b$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-30, 10) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_flood_UKLrel_STRATEGIES_2070.png", width=6, height=1.5, dpi=300)
...
measures_hydro2030b$strategy <- factor(measures_hydro2030b$strategy,levels = c("Baseline", "Reduce ET 30%", "Reduce ET 50%", "Add 30KAF"))
...
ggplot(measures_hydro2030b, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_hydro2030b,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_hydro2030b$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-30, 10) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_hydropower_GEN_STRATEGIES_2030.png", width=6, height=1.5, dpi=300)
...
measures_hydro2070b$strategy <- factor(measures_hydro2070b$strategy,levels = c("Baseline", "Reduce ET 30%", "Reduce ET 50%", "Add 30KAF"))
...
ggplot(measures_hydro2070b, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_hydro2070b,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_hydro2070b$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-30, 10) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_hydropower_GEN_STRATEGIES_2070.png", width=6, height=1.5, dpi=300)
...
measures_wd2030b$strategy <- factor(measures_wd2030b$strategy,levels = c("Baseline", "Reduce ET 30%", "Reduce ET 50%", "Add 30KAF"))
...
ggplot(measures_wd2030b, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_wd2030b,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_wd2030b$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-15, 8) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_wd_KPsupply_STRATEGIES_2030.png", width=6, height=1.5, dpi=300)
...
measures_wd2070b$strategy <- factor(measures_wd2070b$strategy,levels = c("Baseline", "Reduce ET 30%", "Reduce ET 50%", "Add 30KAF"))
...
ggplot(measures_wd2070b, aes(x = scenario, y = pctchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_wd2070b,aes(x=scenario,y=pctchange,label = paste(round(pctchange),"%",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_wd2070b$pctchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-15, 8) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_wd_KPsupply_STRATEGIES_2070.png", width=6, height=1.5, dpi=300)
...
measures_wq2030$strategy <- factor(measures_wq2030$strategy,levels = c("Baseline", "Reduce ET 30%", "Reduce ET 50%", "Add 30KAF"))
ggplot(measures_wq2030, aes(x = scenario, y = magchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_wq2030,aes(x=scenario,y=magchange,label = paste(round(magchange),"",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_wq2030$magchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-5, 10) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_wq_STRATEGIES_2030.png", width=6, height=1.5, dpi=300)

#PLOTS FOR 2070s
measures_wq2070 = measures_wq %>% dplyr::filter(period == 2070)
measures_wq2070$strategy <- factor(measures_wq2070$strategy,levels = c("Baseline", "Reduce ET 30%", "Reduce ET 50%", "Add 30KAF"))
ggplot(measures_wq2070, aes(x = scenario, y = magchange, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_wq2070,aes(x=scenario,y=magchange,label = paste(round(magchange),"",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_wq2070$magchange>=0,0,1), size=2) + scale_fill_brewer(palette = "Paired", name = '', guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(-5, 10) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_wq_STRATEGIES_2070.png", width=6, height=1.5, dpi=300)
