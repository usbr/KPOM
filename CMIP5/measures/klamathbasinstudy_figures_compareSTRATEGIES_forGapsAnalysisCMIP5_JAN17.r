...
wd = "T:/WaterResources/PlanningOperations/8210_Projects/BasinStudies/KlamathBasin/Analysis/ManagementModels/measures"
wd_S1 = "T:/WaterResources/PlanningOperations/8210_Projects/BasinStudies/KlamathBasin/Analysis/ManagementModels/measures_ET70"
wd_S2 = "T:/WaterResources/PlanningOperations/8210_Projects/BasinStudies/KlamathBasin/Analysis/ManagementModels/measures_ET50"
wd_S3 = "T:/WaterResources/PlanningOperations/8210_Projects/BasinStudies/KlamathBasin/Analysis/ManagementModels/measures_30KAF"
wd_sav = "T:/WaterResources/PlanningOperations/8210_Projects/BasinStudies/KlamathBasin/Analysis/ManagementModels/measures/January2017revisions/"
...
measures_eco2030b = measures_eco %>% dplyr::filter(period == 2030, climset == 'CMIP5')
...
ggplot(measures_eco2030b, aes(x = scenario, y = value, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_eco2030b,aes(x=scenario,y=value,label = paste(round(value),"",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_eco2030b$value>=0,0,1), size=2) + scale_fill_manual(values = c("#1f78b4", "#33a02c", "#e31a1c","#ff7f00","#6a3d9a"), guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(0, 40) + theme(axis.text.x=element_text(angle=90), axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
ggsave("measures_eco_LKNWRgapsCMIP5_STRATEGIES_2030.pdf", device = "pdf", width=6, height=1.8, dpi=300)
...
measures_eco2070b = measures_eco %>% dplyr::filter(period == 2070, climset == 'CMIP5')
...
# measures_flood2030b = measures_flood %>% dplyr::filter(period == 2030, climset == 'CMIP5')
...
# ggplot(measures_flood2030b, aes(x = scenario, y = value, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_flood2030b,aes(x=scenario,y=value,label = paste(round(value),"",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_flood2030b$value>=0,0,1), size=2) + scale_fill_manual(values = c("#1f78b4", "#33a02c", "#e31a1c","#ff7f00","#6a3d9a"), guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(0, 50) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
# ggsave("measures_flood_UKLrel_gapsCMIP5_STRATEGIES_2030.pdf", device = "pdf", width=6, height=1.8, dpi=300)
...
# measures_flood2070b = measures_flood %>% dplyr::filter(period == 2070, climset == 'CMIP5')
...
# ggsave("measures_flood_UKLrel_gapsCMIP5_STRATEGIES_2070.pdf", device = "pdf", width=6, height=1.8, dpi=300)
...
# measures_hydro2030b = measures_hydro %>% dplyr::filter(period == 2030, climset == 'CMIP5')
...
# ggplot(measures_hydro2030b, aes(x = scenario, y = value, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_hydro2030b,aes(x=scenario,y=value,label = paste(round(value),"",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_hydro2030b$value>=0,0,1), size=2) + scale_fill_manual(values = c("#1f78b4", "#33a02c", "#e31a1c","#ff7f00","#6a3d9a"), guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(0, 50000) + theme(axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
# ggsave("measures_hydropower_GEN_gapsCMIP5_STRATEGIES_2030.pdf", device = "pdf", width=6, height=1.8, dpi=300)
...
# measures_hydro2070b = measures_hydro %>% dplyr::filter(period == 2070, climset == 'CMIP5')
...
# ggsave("measures_hydropower_GEN_gapsMCIP5_STRATEGIES_2070.pdf", device = "pdf", width=6, height=1.8, dpi=300)
...
# measures_wd2030b = measures_wd %>% dplyr::filter(period == 2030, climset == 'CMIP5')
...
# ggplot(measures_wd2030b, aes(x = scenario, y = value, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_wd2030b,aes(x=scenario,y=value,label = paste(round(value),"",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_wd2030b$value>=0,-0.9,1), size=2) + geom_hline(yintercept = 390, colour="#990000", size=1.0) + scale_fill_manual(values = c("#1f78b4", "#33a02c", "#e31a1c","#ff7f00","#6a3d9a"), guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(0, 600) + theme(axis.text.x=element_text(angle=90), axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
# ggsave("measures_wd_KPsupply_gapsCMIP5_STRATEGIES_2030.pdf", device = "pdf", width=6, height=1.8, dpi=300)
...
# measures_wd2070b = measures_wd %>% dplyr::filter(period == 2070, climset == 'CMIP5')
...
# ggplot(measures_wd2070b, aes(x = scenario, y = value, fill = test)) + geom_bar(stat = 'identity', position = 'dodge') + geom_text(data=measures_wd2070b,aes(x=scenario,y=value,label = paste(round(value),"",sep="")),position=position_dodge(width=0.9), hjust=ifelse(measures_wd2070b$value>=0,-0.9,1), size=2) + geom_hline(yintercept = 390, colour="#990000", size=1.0) + scale_fill_manual(values = c("#1f78b4", "#33a02c", "#e31a1c","#ff7f00","#6a3d9a"), guide = F) + facet_grid(measure_mline~strategy) + coord_flip() + theme_bw() + ylim(0, 600) + theme(axis.text.x=element_text(angle=90), axis.title.x=element_blank(), axis.title.y=element_blank(), strip.text.y = element_text(size = 8, angle = 0), strip.background = element_rect(fill = NA))
# ggsave("measures_wd_KPsupply_gapsCMIP5_STRATEGIES_2070.pdf", device = "pdf", width=6, height=1.8, dpi=300)
...
# ggsave("measures_wq_STRATEGIES_gapsCMIP5_2030.pdf", device = "pdf", width=6, height=1.8, dpi=300)
...
# ggsave("measures_wq_STRATEGIES_gapsCMIP5_2070.pdf", device = "pdf", width=6, height=1.8, dpi=300)
