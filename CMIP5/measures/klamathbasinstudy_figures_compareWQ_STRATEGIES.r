...
#SAVES DATA AS CSV
write.csv(measures_dt, file.path(wd_sav, 'kb_measures_STRATEGY5all.csv'), row.names = F)
...
#measures_wq = measures_dtmag %>% dplyr::filter(category == 'Water Quality')
...
measures_wq2030$strategy <- factor(measures_wq2030$strategy,levels = c("Baseline", "Reduce\nShasta\nScott\n4degC", "Add Flow\n10%", "Add Flow\n20%", "Reduce\nTribs\n4degC", "Reduce\nDam\nOutflow\n4degC"))
...
ggsave("measures_wq_STRATEGYall_2030.png", width=6, height=2, dpi=300)

#PLOTS FOR 2070s
measures_wq2070 = measures_wq %>% dplyr::filter(period == 2070)
measures_wq2070$strategy <- factor(measures_wq2070$strategy,levels = c("Baseline", "Reduce\nShasta\nScott\n4degC", "Add Flow\n10%", "Add Flow\n20%", "Reduce\nTribs\n4degC", "Reduce\nDam\nOutflow\n4degC"))
...
ggsave("measures_wq_STRATEGYall_2070.png", width=6, height=2, dpi=300)
